:source: fortiswitch_system_alertemail.py
...
Synopsis
--------
- This module is able to configure a FortiSwitch device by allowing the user to set and modify system feature and alertemail category. Examples include all parameters and values need to be adjusted to datasources before usage. Tested with FOS v7.0.0
...
.. raw:: html
 ...
 <tr>
 <td>fortiswitch_system_alertemail</td>
 <td><code class="docutils literal notranslate">v7.0.0 -> v7.0.6 </code></td>
 </tr>
 </table>
 <p>
...
.. raw:: html
    ...
    <li> <span class="li-head">system_alertemail</span> - Alert e-mail mail server configuration. <span class="li-normal">type: dict</span> </li>
        <ul class="ul-self">
        ...
        <li> <span class="li-head">source_ip</span> - Set SMTP server source ip. <span class="li-normal">type: str</span> </li>

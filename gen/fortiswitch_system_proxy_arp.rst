:source: fortiswitch_system_proxy_arp.py

:orphan:

.. fortiswitch_system_proxy_arp:
...
Synopsis
--------
- This module is able to configure a FortiSwitch device by allowing the user to set and modify system feature and proxy_arp category. Examples include all parameters and values need to be adjusted to datasources before usage. Tested with FOS v7.0.0
...
.. code-block:: yaml+jinja
    ...
    - name: Configure proxy-arp.
      fortinet.fortiswitch.fortiswitch_system_proxy_arp:
          state: "present"
          system_proxy_arp:
              id: "3"

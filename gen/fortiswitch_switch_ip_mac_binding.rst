:source: fortiswitch_switch_ip_mac_binding.py
...
Synopsis
--------
- This module is able to configure a FortiSwitch device by allowing the user to set and modify switch feature and ip_mac_binding category. Examples include all parameters and values need to be adjusted to datasources before usage. Tested with FOS v7.0.0
...
.. raw:: html
    ...
    <li> <span class="li-head">switch_ip_mac_binding</span> - Ip-mac-binding table. <span class="li-normal">type: dict</span> </li>
        <ul class="ul-self">

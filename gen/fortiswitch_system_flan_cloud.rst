:source: fortiswitch_system_flan_cloud.py
...
Synopsis
--------
- This module is able to configure a FortiSwitch device by allowing the user to set and modify system feature and flan_cloud category. Examples include all parameters and values need to be adjusted to datasources before usage. Tested with FOS v7.0.0
...
.. raw:: html
 ...
 <td><code class="docutils literal notranslate">v7.0.3 -> 7.4.3 </code></td>
 </tr>
 </table>
 <p>

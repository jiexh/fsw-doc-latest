:source: fortiswitch_system_vxlan.py
...
Synopsis
--------
- This module is able to configure a FortiSwitch device by allowing the user to set and modify system feature and vxlan category. Examples include all parameters and values need to be adjusted to datasources before usage. Tested with FOS v7.0.0
...
.. raw:: html
    ...
    <li> <span class="li-head">system_vxlan</span> - Configure VXLAN devices. <span class="li-normal">type: dict</span> </li>
        ...
        <li> <span class="li-head">tagged_vlans</span> - Tagged VLANs. <span class="li-normal">type: str</span> </li>
        <li> <span class="li-head">vlanid</span> - VXLAN VNI mapped VLAN ID. <span class="li-normal">type: int</span> </li>

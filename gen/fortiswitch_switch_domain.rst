:source: fortiswitch_switch_domain.py
...
Synopsis
--------
- This module is able to configure a FortiSwitch device by allowing the user to set and modify switch feature and domain category. Examples include all parameters and values need to be adjusted to datasources before usage. Tested with FOS v7.0.0
...
.. raw:: html
    ...
    <li> <span class="li-head">switch_domain</span> - Switch forwarding domains. <span class="li-normal">type: dict</span> </li>
        ...
        <li> <span class="li-head">vcluster_id</span> - HA virtual cluster id(1-255). <span class="li-normal">type: int</span> </li>
        </ul>
    </ul>

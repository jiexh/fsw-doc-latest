:source: fortiswitch_log_syslogd2_setting.py
...
Synopsis
--------
- This module is able to configure a FortiSwitch device by allowing the user to set and modify log_syslogd2 feature and setting category. Examples include all parameters and values need to be adjusted to datasources before usage. Tested with FOS v7.0.0
...
.. raw:: html
 ...
 <tr>
 <td>fortiswitch_log_syslogd2_setting</td>
...
.. raw:: html
    ...
    <li> <span class="li-head">log_syslogd2_setting</span> - Settings for remote syslog server. <span class="li-normal">type: dict</span> </li>
        <ul class="ul-self">

:source: fortiswitch_system_fortianalyzer3.py
...
Synopsis
--------
- This module is able to configure a FortiSwitch device by allowing the user to set and modify system feature and fortianalyzer3 category. Examples include all parameters and values need to be adjusted to datasources before usage. Tested with FOS v7.0.0
...
.. raw:: html
 ...
 <tr>
 <td>fortiswitch_system_fortianalyzer3</td>
...
.. raw:: html
    ...
    <li> <span class="li-head">system_fortianalyzer3</span> - Setting for FortiAnalyzer. <span class="li-normal">type: dict</span> </li>
        <ul class="ul-self">
...
.. code-block:: yaml+jinja
    ...
    - name: Setting for FortiAnalyzer.
      fortinet.fortiswitch.fortiswitch_system_fortianalyzer3:

:source: fortiswitch_system_certificate_ca.py

:orphan:

.. fortiswitch_system_certificate_ca:
...
Synopsis
--------
- This module is able to configure a FortiSwitch device by allowing the user to set and modify system_certificate feature and ca category. Examples include all parameters and values need to be adjusted to datasources before usage. Tested with FOS v7.0.0
...
.. raw:: html
    ...
    <li> <span class="li-head">system_certificate_ca</span> - CA certificate. <span class="li-normal">type: dict</span> </li>
        <ul class="ul-self">

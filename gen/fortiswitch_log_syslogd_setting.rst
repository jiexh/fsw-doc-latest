:source: fortiswitch_log_syslogd_setting.py

:orphan:

.. fortiswitch_log_syslogd_setting:
...
Synopsis
--------
- This module is able to configure a FortiSwitch device by allowing the user to set and modify log_syslogd feature and setting category. Examples include all parameters and values need to be adjusted to datasources before usage. Tested with FOS v7.0.0
...
.. raw:: html
 ...
 <tr>
 <td>fortiswitch_log_syslogd_setting</td>
...
.. raw:: html
    ...
    <li> <span class="li-head">log_syslogd_setting</span> - Settings for remote syslog server. <span class="li-normal">type: dict</span> </li>
        <ul class="ul-self">
...
.. code-block:: yaml+jinja
    ...
    - name: Settings for remote syslog server.
      fortinet.fortiswitch.fortiswitch_log_syslogd_setting:
          log_syslogd_setting:

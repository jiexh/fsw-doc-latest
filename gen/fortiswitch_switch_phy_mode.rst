:source: fortiswitch_switch_phy_mode.py
...
Synopsis
--------
- This module is able to configure a FortiSwitch device by allowing the user to set and modify switch feature and phy_mode category. Examples include all parameters and values need to be adjusted to datasources before usage. Tested with FOS v7.0.0
...
.. raw:: html
    ...
    <li> <span class="li-head">switch_phy_mode</span> - PHY configuration. <span class="li-normal">type: dict</span> </li>
        <ul class="ul-self">

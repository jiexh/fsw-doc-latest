:source: fortiswitch_log_syslogd3_setting.py
...
Synopsis
--------
- This module is able to configure a FortiSwitch device by allowing the user to set and modify log_syslogd3 feature and setting category. Examples include all parameters and values need to be adjusted to datasources before usage. Tested with FOS v7.0.0
...
.. code-block:: yaml+jinja
    ...
    - name: Settings for remote syslog server.
      fortinet.fortiswitch.fortiswitch_log_syslogd3_setting:

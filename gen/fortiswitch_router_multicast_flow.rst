...
.. raw:: html
    ...
    <li> <span class="li-head">router_multicast_flow</span> - Multicast-flow configuration. <span class="li-normal">type: dict</span> </li>
        ...
        <li> <span class="li-head">flows</span> - Config multicast-flow entries. <span class="li-normal">type: list</span> </li>
            <ul class="ul-self">
            <li> <span class="li-head">group_addr</span> - Multicast group address. <span class="li-normal">type: str</span> </li>
            <li> <span class="li-head">group_addr_end</span> - Multicast group end address. <span class="li-normal">type: str</span> </li>
...
.. code-block:: yaml+jinja
    ...
    - name: Multicast-flow configuration.
      fortinet.fortiswitch.fortiswitch_router_multicast_flow:
          state: "present"

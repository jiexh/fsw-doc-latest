:source: fortiswitch_system_arp_table.py

:orphan:

.. fortiswitch_system_arp_table:
...
Synopsis
--------
- This module is able to configure a FortiSwitch device by allowing the user to set and modify system feature and arp_table category. Examples include all parameters and values need to be adjusted to datasources before usage. Tested with FOS v7.0.0
...
.. code-block:: yaml+jinja
    ...
    - name: Configure arp table.
      fortinet.fortiswitch.fortiswitch_system_arp_table:
          state: "present"
          system_arp_table:
              id: "3"

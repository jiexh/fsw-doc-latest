:source: fortiswitch_log_fortianalyzer3_setting.py

:orphan:

.. fortiswitch_log_fortianalyzer3_setting:
...
Synopsis
--------
- This module is able to configure a FortiSwitch device by allowing the user to set and modify log_fortianalyzer3 feature and setting category. Examples include all parameters and values need to be adjusted to datasources before usage. Tested with FOS v7.0.0
...
.. raw:: html
 ...
 <tr>
 <td>fortiswitch_log_fortianalyzer3_setting</td>
...
.. raw:: html
    ...
    <li> <span class="li-head">log_fortianalyzer3_setting</span> - Setting for FortiAnalyzer. <span class="li-normal">type: dict</span> </li>
        <ul class="ul-self">
...
.. code-block:: yaml+jinja
    ...
    - name: Setting for FortiAnalyzer.
      fortinet.fortiswitch.fortiswitch_log_fortianalyzer3_setting:

:source: fortiswitch_router_setting.py
...
Synopsis
--------
- This module is able to configure a FortiSwitch device by allowing the user to set and modify router feature and setting category. Examples include all parameters and values need to be adjusted to datasources before usage. Tested with FOS v7.0.0
...
.. raw:: html
    ...
    <li> <span class="li-head">router_setting</span> - Set rib settings. <span class="li-normal">type: dict</span> </li>
        <ul class="ul-self">
        <li> <span class="li-head">filter_list</span> - Route filter list configuration. <span class="li-normal">type: list</span> </li>
            <ul class="ul-self">
...
.. code-block:: yaml+jinja
    ...
    - name: Set rib settings.
      fortinet.fortiswitch.fortiswitch_router_setting:
          router_setting:
              filter_list:
                  -
                      id: "4"

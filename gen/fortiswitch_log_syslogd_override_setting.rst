:source: fortiswitch_log_syslogd_override_setting.py

:orphan:

.. fortiswitch_log_syslogd_override_setting:
...
Synopsis
--------
- This module is able to configure a FortiSwitch device by allowing the user to set and modify log_syslogd feature and override_setting category. Examples include all parameters and values need to be adjusted to datasources before usage. Tested with FOS v7.0.0
...
.. raw:: html
 ...
 <tr>
 <td>fortiswitch_log_syslogd_override_setting</td>
...
.. raw:: html
    ...
    <li> <span class="li-head">log_syslogd_override_setting</span> - Settings for remote syslog server. <span class="li-normal">type: dict</span> </li>
        <ul class="ul-self">
        ...
        <li> <span class="li-head">override</span> - Override syslog settings or use the global settings. <span class="li-normal">type: str</span> <span class="li-normal">choices: enable, disable</span> </li>
        ...
        <li> <span class="li-head">source_ip</span> - Source IP address of the syslog. <span class="li-normal">type: str</span> </li>
        <li> <span class="li-head">status</span> - Whether to enable remote syslog log. <span class="li-normal">type: str</span> <span class="li-normal">choices: enable, disable</span> </li>
        </ul>
    </ul>

:source: fortiswitch_system_console.py
...
Synopsis
--------
- This module is able to configure a FortiSwitch device by allowing the user to set and modify system feature and console category. Examples include all parameters and values need to be adjusted to datasources before usage. Tested with FOS v7.0.0
...
.. raw:: html
    ...
    <li> <span class="li-head">system_console</span> - Configure console. <span class="li-normal">type: dict</span> </li>
        <ul class="ul-self">

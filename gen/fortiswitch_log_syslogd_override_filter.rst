:source: fortiswitch_log_syslogd_override_filter.py
...
Synopsis
--------
- This module is able to configure a FortiSwitch device by allowing the user to set and modify log_syslogd feature and override_filter category. Examples include all parameters and values need to be adjusted to datasources before usage. Tested with FOS v7.0.0
...
.. raw:: html
 ...
 <tr>
 <td>fortiswitch_log_syslogd_override_filter</td>
...
.. raw:: html
    ...
    <li> <span class="li-head">log_syslogd_override_filter</span> - Override filters for remote system server. <span class="li-normal">type: dict</span> </li>
        <ul class="ul-self">
...
.. code-block:: yaml+jinja
    ...
    - name: Override filters for remote system server.
      fortinet.fortiswitch.fortiswitch_log_syslogd_override_filter:

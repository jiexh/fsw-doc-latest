:source: fortiswitch_user_group.py
...
.. raw:: html
    ...
    <li> <span class="li-head">user_group</span> - User group configuration. <span class="li-normal">type: dict</span> </li>
        <ul class="ul-self">
        <li> <span class="li-head">authtimeout</span> - Authentication timeout (0 - 480). <span class="li-normal">type: int</span> </li>
        <li> <span class="li-head">group_type</span> - Type of user group. <span class="li-normal">type: str</span> <span class="li-normal">choices: firewall</span> </li>
        ...
        <li> <span class="li-head">match</span> - Set group matches. <span class="li-normal">type: list</span> </li>
            <ul class="ul-self">
            ...
            <li> <span class="li-head">server_name</span> - Name of remote authentication server. <span class="li-normal">type: str</span> </li>
            </ul>
        <li> <span class="li-head">member</span> - Group members. <span class="li-normal">type: list</span> </li>
            <ul class="ul-self">
            <li> <span class="li-head">name</span> - Group member name. <span class="li-normal">type: str</span> </li>
            </ul>

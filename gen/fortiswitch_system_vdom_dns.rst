:source: fortiswitch_system_vdom_dns.py

:orphan:

.. fortiswitch_system_vdom_dns:
...
Synopsis
--------
- This module is able to configure a FortiSwitch device by allowing the user to set and modify system feature and vdom_dns category. Examples include all parameters and values need to be adjusted to datasources before usage. Tested with FOS v7.0.0
...
.. raw:: html
    ...
    <li> <span class="li-head">system_vdom_dns</span> - Vdom dns configuration. <span class="li-normal">type: dict</span> </li>
        <ul class="ul-self">
...
.. code-block:: yaml+jinja
    ...
    - name: Vdom dns configuration.
      fortinet.fortiswitch.fortiswitch_system_vdom_dns:
          system_vdom_dns:

:source: fortiswitch_router_prefix_list.py
...
Synopsis
--------
- This module is able to configure a FortiSwitch device by allowing the user to set and modify router feature and prefix_list category. Examples include all parameters and values need to be adjusted to datasources before usage. Tested with FOS v7.0.0
...
.. raw:: html
 ...
 <tr>
 <td>fortiswitch_router_prefix_list</td>
...
.. raw:: html
    ...
    <li> <span class="li-head">router_prefix_list</span> - Prefix list configuration. <span class="li-normal">type: dict</span> </li>
        <ul class="ul-self">

:source: fortiswitch_execute_backup_standalone_config.py

:orphan:

.. fortiswitch_execute_backup_standalone_config:
...
.. raw:: html
    ...
    <li> <span class="li-head">execute_backup_standalone_config</span> - Backup Switch's Standalone Configuration. <span class="li-normal">type: dict</span> </li>
        <ul class="ul-self">

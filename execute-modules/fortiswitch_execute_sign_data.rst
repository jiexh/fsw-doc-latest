:source: fortiswitch_execute_sign_data.py

:orphan:

.. fortiswitch_execute_sign_data:
...
.. raw:: html
    ...
    <li> <span class="li-head">execute_sign_data</span> - Sign data with a local certificate. <span class="li-normal">type: dict</span> </li>
        <ul class="ul-self">
        <li> <span class="li-head">certificate</span> - Certificate data for the Verification. <span class="li-normal">type: str</span> </li>
        <li> <span class="li-head">signature</span> - Signed data(Base64 Encoded) for the Verification. <span class="li-normal">type: str</span> </li>
        </ul>
    </ul>
